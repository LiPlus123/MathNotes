...
def FormulaAssignment {Var : Type} (v : Assignment Var) : Formula Var → truth_value
  | Formula.var p => v p
  | Formula.neg phi => neg_truth_func (FormulaAssignment v phi)
  | Formula.imp phi psi => imp_truth_func (FormulaAssignment v phi) (FormulaAssignment v psi)

abbrev formula_assignment_l_0 : assignment_l_0 -> formula_l_0 -> truth_value := FormulaAssignment

theorem conj_formula_assignment (v : assignment_l_0) (phi psi : formula_l_0) :
  formula_assignment_l_0 v (conj_l_0 phi psi) = conj_truth_func (formula_assignment_l_0 v phi) (formula_assignment_l_0 v psi) := by
  sorry

theorem disj_formula_assignment (v : assignment_l_0) (phi psi : formula_l_0) :
  formula_assignment_l_0 v (disj_l_0 phi psi) = disj_truth_func (formula_assignment_l_0 v phi) (formula_assignment_l_0 v psi) := by
  sorry

theorem bicond_formula_assignment (v : assignment_l_0) (phi psi : formula_l_0) :
  formula_assignment_l_0 v (bicon_l_0 phi psi) = bicond_truth_func (formula_assignment_l_0 v phi) (formula_assignment_l_0 v psi) := by
  sorry
